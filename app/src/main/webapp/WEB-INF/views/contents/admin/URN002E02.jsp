		...
		<c:choose>
				...
				<form id="updateForm" name="update" action="/admin/notice/update" method="post">
					<table class="table table-bordered">
						...
						<tr>
							...
							<td width="40%"><select id="notice_category" name="notice_category" class="form-select">
							...
							<td width="40%"><select id="notice_entireRegionalCode" name="notice_entireRegionalCode" class="form-select">
						...
						<tr>
							...
							<td colspan="3"><input type="text" id="notice_title" name="notice_title" value="${notice.notice_title }" class="col-sm-12 col-form-label"></td>
						</tr>
						<tr>
							<td class="text-center align-middle"><strong>내&nbsp;&nbsp;용</strong></td>
							<td colspan="3"><textarea id="notice_content" name="notice_content" rows="7" class="col-sm-12 col-form-label">${notice.notice_content }</textarea></td>
						</tr>
						<tr>
							<td class="text-center"><strong>링&nbsp;&nbsp;크</strong></td>
							<td colspan="3"><input type="text" id="notice_link" name="notice_link" value="${notice.notice_link }" class="col-sm-12 col-form-label"></td>
			...
			<c:otherwise>
				...
				<table class="table table-bordered">
					...
					<tr>
						<td class="text-center"><strong>제&nbsp;&nbsp;목</strong></td>
						<td colspan="3"><input type="text" id="notice_title" name="notice_title" class="col-sm-12 col-form-label"></td>
					</tr>
					<tr>
						<td class="text-center align-middle"><strong>내&nbsp;&nbsp;용</strong></td>
						<td colspan="3"><textarea id="notice_content" name="notice_content" rows="7" class="col-sm-12 col-form-label"></textarea></td>
					</tr>
					<tr>
						<td class="text-center"><strong>링&nbsp;&nbsp;크</strong></td>
						<td colspan="3"><input type="text" id="notice_link" name="notice_link" class="col-sm-12 col-form-label col-form-label-sm"></td>
					</tr>
